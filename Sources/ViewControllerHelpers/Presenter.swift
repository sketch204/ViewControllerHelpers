...
struct NavigationStackPresenter: Presenter {
    ...
    var clearNavigationStack = false
    ...
    var presentModallyIfNoViewController = true
    var animated = true
...
struct ModalPresenter: Presenter {
    ...
    var presentationStyle: UIModalPresentationStyle = ModalPresenter.defaultPresentationStyle
