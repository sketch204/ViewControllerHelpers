...
extension Storyboarded where Self: UIViewController {
    ...
    public static func instantiate(storyboardName: String = Self.storyboardName,
    ...
    public static func instantiateWithNavController(storyboardName: String = Self.storyboardName,
